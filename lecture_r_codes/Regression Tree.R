...
#For each node in the tree, the number of examples reaching the decision point is listed. For instance, all 3,429 examples begin at the
#root node, of which 2,155 have alcohol < 10.85 and 1,274 have alcohol >= 10.85. Because alcohol was used first in the tree,
#it is the single most important predictor of wine quality.
